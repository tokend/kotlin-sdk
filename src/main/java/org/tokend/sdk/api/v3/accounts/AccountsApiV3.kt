...
open class AccountsApiV3(
     ...
     */
    @JvmOverloads
    open fun get(params: AccountsPageParamsV3? = null): ApiRequest<DataPage<AccountResource>> {
     ...
     */
    open fun getRoleById(
        roleId: String,
        params: AccountRoleParamsV3? = null
    ): ApiRequest<AccountRoleResource> {
        return MappedRetrofitApiRequest(
